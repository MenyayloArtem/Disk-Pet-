...
const borderStyles = {
  [InputType.Default]:
    "border-gray-300 text-gray-500 placeholder:text-gray-500",
...
function Input(props: Props) {
  ...
  return (
    <div className={` ${borderStyles[borderType]}`} style={{ width }}>
    ...
    `}
      ...
      <div className="mt-1 pointer-events-none">{props.bottom}</div>
    </div>
  );
}
