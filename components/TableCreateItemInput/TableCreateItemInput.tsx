  ...
  return (
    <div className="flex">
      <Input
        ...
        placeholder={fileType === "file" ? "File Name" : "Folder Name"}
        ...
        after={<Button onClick={() => beforeCreate(newElName)}>OK</Button>}
        bottom={
          fileWarn && <div className="text-red-400 text-xs">{fileWarn}</div>
        }
      />
    </div>
  );
